                        ...
                        <Slider {...settings}>
                            {items.map((item, i) => (
                                <div onMouseLeave={() => setHovering(false)} onMouseEnter={() => {
                                    setHovering(true)
                                    setCounter(0)
                                }} key={i} className="product-item translate-x-3 min-w-[215px] max-w-[215px] smmax:min-w-[170px] smmax:max-w-[170px] h-[250px] bg-white overflow-hidden snap-center rounded-md">
